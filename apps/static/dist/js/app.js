  ...
  $.AdminLTE.tree = function (menu) {
    ...
    .on('click', menu + ' li a', function(e) {
      ...
      TimeFn = setTimeout(function(){
        SELECTEDTREEID = $this.attr("id");
        $(".selectnode").parent("li").removeClass("active");
        $(".selectnode").removeClass("selectnode");
        if ($this.attr("nodetype") == "serviceunit") {
    ...
    $(document).off('dblclick', menu + ' li a')
      .on('dblclick', menu + ' li a', function (e) {
